    ...
    return (
        <div {...props} className={'tile'}>
            ...
            <div className="tile-content">
                ...
                <span className="tile-title_2 tile-title">{filteredname[0].tilecopy1}</span>
                <p className="tile-desc">
                    <span className="tile-desc-line_1 tile-desc-line">{filteredname[0].tilecopy2}</span>
                    <span className="tile-desc-line_2 tile-desc-line">{filteredname[0].tilecopy3}</span>
                    <span className="tile-desc-line tile-desc-line_3">{filteredname[0].tilecopy4}</span>
                </p>
