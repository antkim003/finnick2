    ...
    return React.createClass({
        ...
        componentWillMount: function() {
            if (referenceColumn) {
                ...
                var $currNodeRel = $(ReactDOM.findDOMNode(this)).parent().attr('data-cell');
                var rowNumber = $currNodeRel.split('-')[0];
                categories = dat.state.data[rowNumber][referenceColumn];
//                console.log(rowNumber, referenceColumn, dat.state.data, 'in check', $(ReactDOM.findDOMNode(this)).parent())
            }
        },
